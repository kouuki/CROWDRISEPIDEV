...
class ProblemController extends Controller {
    ...
    public function ConsulterProbAction($categorie) {
        $em = $this->getDoctrine()->getManager();
        
        $probleme = $em->getRepository('PIDEVCrowdRiseBundle:Probleme')->findBy(array('categorie' => $categorie));
      
        return $this->render('PIDEVCrowdRiseBundle:Problem:listProblemeSolver.html.twig', array('problemes' => $probleme));
    }
