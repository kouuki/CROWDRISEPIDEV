 ...
 */
class Media extends \PIDEV\CrowdRiseBundle\Entity\Media implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'PIDEV\\CrowdRiseBundle\\Entity\\Media' . "\0" . 'id', '' . "\0" . 'PIDEV\\CrowdRiseBundle\\Entity\\Media' . "\0" . 'updateAt', 'name', 'path', 'file'];
        }

        return ['__isInitialized__', '' . "\0" . 'PIDEV\\CrowdRiseBundle\\Entity\\Media' . "\0" . 'id', '' . "\0" . 'PIDEV\\CrowdRiseBundle\\Entity\\Media' . "\0" . 'updateAt', 'file'];
    }
