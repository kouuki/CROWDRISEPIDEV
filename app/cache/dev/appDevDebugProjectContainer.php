...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'notification_controller' => 'getNotificationControllerService',
    ...
    {
        return $this->services['dcs_rating.manager.rating.default'] = new \DCS\RatingBundle\Entity\RatingManager($this->get('debug.event_dispatcher'), $this->get('doctrine.orm.default_entity_manager'), 'PIDEV\\CrowdRiseBundle\\Entity\\Rating');
    }
    ...
    {
        return $this->services['dcs_rating.manager.vote.default'] = new \DCS\RatingBundle\Entity\VoteManager($this->get('debug.event_dispatcher'), $this->get('doctrine.orm.default_entity_manager'), 'PIDEV\\CrowdRiseBundle\\Entity\\Vote');
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'CrowdRise', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    {
        $a = new \Doctrine\ORM\Mapping\Driver\SimplifiedXmlDriver(array(($this->targetDirs[3].'\\vendor\\damianociarla\\rating-bundle\\DCS\\RatingBundle\\Resources\\config\\doctrine') => 'DCS\\RatingBundle\\Entity'));
        $a->setGlobalBasename('mapping');

        $b = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $b->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'\\src\\PIDEV\\CrowdRiseBundle\\Entity'))), 'PIDEV\\CrowdRiseBundle\\Entity');
        $b->addDriver($a, 'DCS\\RatingBundle\\Entity');
        ...
        $c->setEntityNamespaces(array('PIDEVCrowdRiseBundle' => 'PIDEV\\CrowdRiseBundle\\Entity', 'DCSRatingBundle' => 'DCS\\RatingBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_69fbb3972d722921345155a9727c35a17a01089182f61c0e452417faa7cffaf7');
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('PIDEV\\CrowdRiseBundle\\Entity\\Membre');
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('PIDEV\\CrowdRiseBundle\\Entity\\Membre');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('PIDEV\\CrowdRiseBundle\\Entity\\Membre');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('PIDEV\\CrowdRiseBundle\\Entity\\Membre');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'PIDEV\\CrowdRiseBundle\\Entity\\Membre');
    }
    ...
    /**
     * Gets the 'notification_controller' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \PIDEV\CrowdRiseBundle\Controller\NotificationController A PIDEV\CrowdRiseBundle\Controller\NotificationController instance.
     */
    protected function getNotificationControllerService()
    {
        return $this->services['notification_controller'] = new \PIDEV\CrowdRiseBundle\Controller\NotificationController();
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \PIDEV\CrowdRiseBundle\Redirection\AfterLoginRedirection A PIDEV\CrowdRiseBundle\Redirection\AfterLoginRedirection instance.
     */
    protected function getRedirect_After_LoginService()
    {
        return $this->services['redirect.after.login'] = new \PIDEV\CrowdRiseBundle\Redirection\AfterLoginRedirection($this->get('router'));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $j = new \Symfony\Component\HttpFoundation\RequestMatcher('^/ajoutDemande/');

        $k = new \Symfony\Component\HttpFoundation\RequestMatcher('^/AjouterProjet');

        $l = new \Symfony\Component\HttpFoundation\RequestMatcher('^/ajouter');
        ...
        $n->add($j, array(0 => 'ROLE_SOLVER'), NULL);
        $n->add($k, array(0 => 'ROLE_SUBMITTER'), NULL);
        $n->add($l, array(0 => 'ROLE_SUBMITTER'), NULL);
        $n->add($m, array(0 => 'ROLE_ADMIN'), NULL);

        $o = new \Symfony\Component\Security\Http\HttpUtils($d, $d);

        $p = new \Symfony\Component\Security\Http\Firewall\LogoutListener($b, $o, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($o, 'pidev_crowd_rise_accueil'), array('csrf_parameter' => '_csrf_token', 'intention' => 'logout', 'logout_path' => 'fos_user_security_logout'));
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $a->setUsername('crowdsf1516@gmail.com');
        $a->setPassword('test2016');
        $a->setAuthMode('login');
    ...
    protected function getTranslator_DefaultService()
    {
        ...
        $instance->addResource('xlf', ($this->targetDirs[3].'\\src\\PIDEV\\CrowdRiseBundle/Resources/translations\\messages.fr.xlf'), 'fr', 'messages');
        ...
        $instance->addResource('xlf', ($this->targetDirs[3].'\\src\\PIDEV\\MailBundle/Resources/translations\\messages.fr.xlf'), 'fr', 'messages');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\PIDEV\\MailBundle/Resources/views'), 'PidevMail');
    ...
    {
        return $this->services['security.role_hierarchy'] = new \Symfony\Component\Security\Core\Role\RoleHierarchy(array('ROLE_SOLVER' => array(0 => 'ROLE_SOLVER'), 'ROLE_SUBMITTER' => array(0 => 'ROLE_SUBMITTER'), 'ROLE_ADMIN' => array(0 => 'ROLE_USER'), 'ROLE_SUPER_ADMIN' => array(0 => 'ROLE_ADMIN')));
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'PidevMailBundle' => 'Pidev\\MailBundle\\PidevMailBundle',
            ...
            'database_port' => NULL,
            'database_name' => 'CrowdRise',
            'database_user' => 'root',
            'database_password' => NULL,
            'mailer_transport' => 'gmail',
            'mailer_host' => 'smtp.gmail.com',
            'mailer_user' => 'crowdsf1516@gmail.com',
            'mailer_password' => 'test2016',
            'locale' => 'fr',
            ...
            'security.access.denied_url' => '/accesdenied',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'crowdsf1516@gmail.com',
            'swiftmailer.mailer.default.transport.smtp.password' => 'test2016',
            ...
            'fos_user.model.user.class' => 'PIDEV\\CrowdRiseBundle\\Entity\\Membre',
            ...
            'dcs_rating.model.rating.class' => 'PIDEV\\CrowdRiseBundle\\Entity\\Rating',
            'dcs_rating.model.vote.class' => 'PIDEV\\CrowdRiseBundle\\Entity\\Vote',
